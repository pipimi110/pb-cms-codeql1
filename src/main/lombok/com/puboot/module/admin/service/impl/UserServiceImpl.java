...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public boolean updateStatusBatch(List<String> userIds, Integer status) {
        return update(Wrappers.<User>lambdaUpdate().in(User::getUserId, userIds).set(User::getStatus, status).set(User::getUpdateTime, new Date()));
    }
    ...
    public UserServiceImpl(final RedisSessionDAO redisSessionDAO, final SessionManager sessionManager, final RedisCacheManager redisCacheManager, final UserMapper userMapper, final UserRoleMapper userRoleMapper) {
