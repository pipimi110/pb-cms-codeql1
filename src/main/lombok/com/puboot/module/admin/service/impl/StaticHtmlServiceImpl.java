...
public class StaticHtmlServiceImpl implements StaticHtmlService {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(StaticHtmlServiceImpl.class);
    ...
    @java.lang.SuppressWarnings("all")
    public StaticHtmlServiceImpl(final StaticizeProperties staticizeProperties, final TemplateEngine templateEngine, final BizArticleService bizArticleService, final BizCategoryService bizCategoryService, final BizTagsService bizTagsService, final BizArticleTagsService bizArticleTagsService, final BizThemeService bizThemeService, final CommonDataService commonDataService) {
        this.staticizeProperties = staticizeProperties;
        ...
        this.bizArticleTagsService = bizArticleTagsService;
        this.bizThemeService = bizThemeService;
