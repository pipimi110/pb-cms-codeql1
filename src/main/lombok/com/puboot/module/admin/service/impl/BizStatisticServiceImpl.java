...
public class BizStatisticServiceImpl implements BizStatisticService {
    ...
    public BizStatisticServiceImpl(final BizArticleService articleService, final BizCommentService commentService, final BizArticleLookService articleLookService) {
