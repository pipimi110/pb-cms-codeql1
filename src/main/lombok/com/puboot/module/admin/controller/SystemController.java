...
public class SystemController {
    ...
    *//*提交注册*//*
    ...
    @java.lang.SuppressWarnings("all")
    public SystemController(final UserService userService, final PermissionService permissionService, final BizCategoryService bizCategoryService, final SysConfigService configService) {
