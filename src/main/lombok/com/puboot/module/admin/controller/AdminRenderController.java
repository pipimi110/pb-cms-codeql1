...
public class AdminRenderController {
    ...
    public AdminRenderController(final BizCategoryService categoryService, final SysConfigService sysConfigService, final PermissionService permissionService, final BizStatisticService statisticService) {
