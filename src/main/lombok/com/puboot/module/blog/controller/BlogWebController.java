...
public class BlogWebController {
    ...
    public String index(@PathVariable(value = "pageNumber", required = false) Integer pageNumber, ArticleConditionVo vo, Model model) {
    ...
    public String tag(@PathVariable("tagId") Integer tagId, @PathVariable(value = "pageNumber", required = false) Integer pageNumber, Model model) {
        if (CoreConst.SITE_STATIC.get()) {
    ...
    public BlogWebController(final BizArticleService bizArticleService, final BizCategoryService categoryService, final BizThemeService bizThemeService) {
